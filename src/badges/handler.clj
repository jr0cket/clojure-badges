(ns badges.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [badges.routes.home :refer [home-routes]]
            [badges.middleware :as middleware]
            [badges.session :as session]
...
(defn destroy
  ...
  []
  (timbre/info "badges is shutting down...")
  (stop-nrepl)
